...
import dz.procsys.api.core.system.audit.dto.AuditedDTO;
import dz.procsys.api.core.system.audit.service.AuditedService;
import dz.procsys.api.core.system.audit.service.AuditedService.UserActivitySummary;
...
public class AuditedController extends GenericController<AuditedDTO, Long> {
    ...
    @Operation(
        ...
        description = "Get the total count of all audit log entries in the domain. Useful for dashboard statistics and reporting."
    )
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
