...
package dz.procsys.api.core.system.utility.controller;
...
import dz.procsys.api.platform.kernel.GenericController;
import dz.procsys.api.core.system.utility.dto.FileDTO;
import dz.procsys.api.core.system.utility.service.FileService;
...
public class FileController extends GenericController<FileDTO, Long> {
    ...
    @Operation(
        summary = "Upload file",
        description = "Upload a new file to the domain. Generates unique storage path, validates file type and size, and stores metadata. Maximum file size and allowed extensions are configured server-side."
    )
    @ApiResponses(value = {
