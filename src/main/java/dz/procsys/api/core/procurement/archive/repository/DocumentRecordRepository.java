...
import dz.procsys.api.core.procurement.archive.repository.projection.DocumentRecordSearchView;
...
public interface DocumentRecordRepository extends JpaRepository<DocumentRecord, Long> {
    ...
    @Query("""
        select d.id as id,
               ...
               d.supplierReference as supplierReference,
               d.contractReference as contractReference,
               d.fiscalPeriod as fiscalPeriod,
               af.id as archiveFolderId,
               af.code as archiveFolderCode
          from DocumentRecord d
          join d.archiveFolder af
        ...
        """)
    Page<DocumentRecordSearchView> searchByClassification(
